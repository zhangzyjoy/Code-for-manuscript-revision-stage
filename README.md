...
- $\overline \Phi (\psi_i^e) = [ \overline \Phi _x(\psi_{i,x} ^e), \overline \Phi _y(\psi_{i,y} ^e), \overline \Phi _z(\psi_{i,z} ^e)]^T$ : first derivative of intermediate auxiliary rotational error
